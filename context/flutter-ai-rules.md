...
> Source: https://raw.githubusercontent.com/flutter/flutter/refs/heads/main/docs/rules/rules_10k.md
> Fetched: 2026-05-19
>
> **Note for pandoc_jaspr**: this is the official Flutter/Dart AI rules
> template. Roughly the bottom third (Material 3 theming, GoRouter, layout
> widgets, accessibility for widgets) is Flutter-specific and does not apply
> to this pure-Dart package. The top half (Interaction Guidelines, Code
> Quality, Dart Best Practices, Documentation Philosophy, Analysis Options)
> is framework-agnostic and is what the spike should lean on. Section
> headings are preserved so the spike can pick what applies.
