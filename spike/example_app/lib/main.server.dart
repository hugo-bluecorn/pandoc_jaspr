...
// Hide AST classes that collide with jaspr_content's UI component names.
            ...
            groups: [
              ...
              SidebarGroup(
                ...
                links: [
                  ...
                  // /article.pandoc — the FilesystemLoader strips the
                  // final `.json` extension only; the `.pandoc` segment
                  // stays in the route URL.
                  SidebarLink(text: "Article", href: '/article.pandoc'),
                ],
              ),
            ],
          ),
